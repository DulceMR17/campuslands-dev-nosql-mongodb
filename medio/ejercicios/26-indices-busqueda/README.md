...
ecommerce y videojuegos

## Contexto del problema

Vas a construir una solucion MongoDB para un caso de ecommerce y videojuegos. El ejercicio se enfoca en indices y explain, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_indices_busqueda`.
...
```text
medio/ejercicios/26-indices-busqueda/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
