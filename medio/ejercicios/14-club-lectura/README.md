...
Vas a construir una solucion MongoDB para un caso de libros. El ejercicio se enfoca en progreso y reportes, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_club_lectura`.
...
```text
medio/ejercicios/14-club-lectura/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
