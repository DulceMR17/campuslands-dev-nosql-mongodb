...
Vas a construir una solucion MongoDB para un caso de musica. El ejercicio se enfoca en preferencias y scores, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_recomendador_musica`.
...
```javascript
use campus_recomendador_musica
...
```text
medio/ejercicios/11-recomendador-musica/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
