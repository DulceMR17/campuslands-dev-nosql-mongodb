...
campus y cultura digital

## Contexto del problema

Vas a construir una solucion MongoDB para un caso de campus y cultura digital. El ejercicio se enfoca en integracion intermedia, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_proyecto_medio`.
...
```text
medio/ejercicios/30-proyecto-medio/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
