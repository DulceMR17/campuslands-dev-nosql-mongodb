...
Vas a construir una solucion MongoDB para un caso de carreras. El ejercicio se enfoca en analisis de tiempos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_pitstop_carreras`.
...
```text
medio/ejercicios/08-pitstop-carreras/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
