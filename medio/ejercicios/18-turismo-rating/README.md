...
Vas a construir una solucion MongoDB para un caso de turismo. El ejercicio se enfoca en promedios y filtros, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_turismo_rating`.
...
```text
medio/ejercicios/18-turismo-rating/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
