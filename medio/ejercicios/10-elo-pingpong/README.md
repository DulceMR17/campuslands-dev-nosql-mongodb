...
Vas a construir una solucion MongoDB para un caso de pingpong. El ejercicio se enfoca en updates acumulados, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_elo_pingpong`.
...
```text
medio/ejercicios/10-elo-pingpong/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
