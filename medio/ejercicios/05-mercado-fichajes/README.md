...
Vas a construir una solucion MongoDB para un caso de futbol. El ejercicio se enfoca en aggregation con calculos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_mercado_fichajes`.
...
```text
medio/ejercicios/05-mercado-fichajes/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
