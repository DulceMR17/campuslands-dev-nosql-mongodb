...
Vas a construir una solucion MongoDB para un caso de dibujo. El ejercicio se enfoca en cotizacion documental, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_comisiones_dibujo`.
...
```text
medio/ejercicios/21-comisiones-dibujo/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
