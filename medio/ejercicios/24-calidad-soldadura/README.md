...
Vas a construir una solucion MongoDB para un caso de soldadura. El ejercicio se enfoca en reportes de defectos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_calidad_soldadura`.
...
```text
medio/ejercicios/24-calidad-soldadura/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
