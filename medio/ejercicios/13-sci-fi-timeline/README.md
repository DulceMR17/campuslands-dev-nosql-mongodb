...
Vas a construir una solucion MongoDB para un caso de ciencia ficcion. El ejercicio se enfoca en orden cronologico avanzado, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_sci_fi_timeline`.
...
```text
medio/ejercicios/13-sci-fi-timeline/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
