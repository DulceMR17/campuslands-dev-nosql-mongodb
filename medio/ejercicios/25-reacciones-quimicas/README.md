...
Vas a construir una solucion MongoDB para un caso de formulas quimicas. El ejercicio se enfoca en documentos cientificos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_reacciones_quimicas`.
...
```javascript
use campus_reacciones_quimicas
...
```text
medio/ejercicios/25-reacciones-quimicas/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
