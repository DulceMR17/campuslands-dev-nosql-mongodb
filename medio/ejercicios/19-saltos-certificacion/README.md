...
Vas a construir una solucion MongoDB para un caso de paracaidismo. El ejercicio se enfoca en reglas de elegibilidad, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_saltos_certificacion`.
...
```javascript
use campus_saltos_certificacion
...
```text
medio/ejercicios/19-saltos-certificacion/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
