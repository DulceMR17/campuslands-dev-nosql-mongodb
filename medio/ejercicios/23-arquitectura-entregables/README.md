# 23. Entregables arquitectura 3D
...
Vas a construir una solucion MongoDB para un caso de diseno 3D arquitectura. El ejercicio se enfoca en seguimiento de proyectos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_arquitectura_entregables`.
4. Inserta al menos 10 documentos coherentes.
...
- Crea minimo 2 colecciones o documentos anidados bien justificados.
...
```javascript
use campus_arquitectura_entregables
...
```text
medio/ejercicios/23-arquitectura-entregables/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
