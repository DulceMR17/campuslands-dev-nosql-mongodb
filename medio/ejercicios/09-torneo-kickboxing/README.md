...
Vas a construir una solucion MongoDB para un caso de kickboxing. El ejercicio se enfoca en brackets y resultados, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_torneo_kickboxing`.
...
```text
medio/ejercicios/09-torneo-kickboxing/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
