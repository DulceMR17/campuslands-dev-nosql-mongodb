...
Vas a construir una solucion MongoDB para un caso de bases de datos. El ejercicio se enfoca en modelado comparativo, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_migracion_sql_nosql`.
...
```javascript
use campus_migracion_sql_nosql
...
```text
medio/ejercicios/29-migracion-sql-nosql/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
