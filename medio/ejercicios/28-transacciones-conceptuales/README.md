...
Vas a construir una solucion MongoDB para un caso de marketplace. El ejercicio se enfoca en consistencia en operaciones, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_transacciones_conceptuales`.
...
```javascript
use campus_transacciones_conceptuales
...
```text
medio/ejercicios/28-transacciones-conceptuales/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
