...
Vas a construir una solucion MongoDB para un caso de comida. El ejercicio se enfoca en estados y auditoria, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_delivery_comida`.
...
```text
medio/ejercicios/15-delivery-comida/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
