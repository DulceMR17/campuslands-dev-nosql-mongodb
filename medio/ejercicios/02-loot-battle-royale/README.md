# 02. Loot por zonas battle royale
...
Vas a construir una solucion MongoDB para un caso de videojuegos battle royale. El ejercicio se enfoca en unwind y agrupaciones, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_loot_battle_royale`.
...
```text
medio/ejercicios/02-loot-battle-royale/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
