...
Vas a construir una solucion MongoDB para un caso de viajes. El ejercicio se enfoca en consultas por presupuesto, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_planner_viajes`.
...
```text
medio/ejercicios/17-planner-viajes/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
