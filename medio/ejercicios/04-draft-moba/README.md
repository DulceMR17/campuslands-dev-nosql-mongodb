...
Vas a construir una solucion MongoDB para un caso de videojuegos MOBA. El ejercicio se enfoca en operadores compuestos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_draft_moba`.
...
```text
medio/ejercicios/04-draft-moba/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
