...
Vas a construir una solucion MongoDB para un caso de motos. El ejercicio se enfoca en series de lecturas, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_telemetria_motos`.
...
```text
medio/ejercicios/06-telemetria-motos/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
