# 12. Reviews de peliculas de miedo
...
Vas a construir una solucion MongoDB para un caso de peliculas de miedo. El ejercicio se enfoca en subdocumentos y ratings, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_terror_reviews`.
...
```text
medio/ejercicios/12-terror-reviews/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
