...
Vas a construir una solucion MongoDB para un caso de animacion 3D. El ejercicio se enfoca en colas y prioridades, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_render_farm`.
...
```text
medio/ejercicios/22-render-farm/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
