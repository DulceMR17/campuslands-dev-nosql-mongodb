# 01. Dashboard shooter con aggregation
...
Vas a construir una solucion MongoDB para un caso de videojuegos shooters. El ejercicio se enfoca en pipeline aggregation basico, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_aggregation_shooter`.
...
```javascript
use campus_aggregation_shooter
...
```text
medio/ejercicios/01-aggregation-shooter/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
