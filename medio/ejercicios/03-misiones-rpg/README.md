...
Vas a construir una solucion MongoDB para un caso de videojuegos RPG. El ejercicio se enfoca en embebido vs referenciado, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_misiones_rpg`.
...
```text
medio/ejercicios/03-misiones-rpg/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
