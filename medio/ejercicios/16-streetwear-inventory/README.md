...
Vas a construir una solucion MongoDB para un caso de ropa. El ejercicio se enfoca en variantes complejas, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_streetwear_inventory`.
...
```javascript
use campus_streetwear_inventory
...
```text
medio/ejercicios/16-streetwear-inventory/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
