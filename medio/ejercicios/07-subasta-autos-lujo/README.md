...
Vas a construir una solucion MongoDB para un caso de autos de lujo. El ejercicio se enfoca en documentos historicos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_subasta_autos_lujo`.
...
```text
medio/ejercicios/07-subasta-autos-lujo/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
