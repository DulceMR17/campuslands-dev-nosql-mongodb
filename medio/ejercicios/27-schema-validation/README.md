# 27. Schema validation intermedio
...
Vas a construir una solucion MongoDB para un caso de tecnologia. El ejercicio se enfoca en validacion documental, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_schema_validation`.
...
```text
medio/ejercicios/27-schema-validation/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
