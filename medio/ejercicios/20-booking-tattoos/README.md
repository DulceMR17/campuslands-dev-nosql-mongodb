...
Vas a construir una solucion MongoDB para un caso de tatuajes. El ejercicio se enfoca en agenda sin choques, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_booking_tattoos`.
...
```text
medio/ejercicios/20-booking-tattoos/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
